 ...
 *
 * `design/tokens.json` states two weights off the hundred — `type.peekFromPrice`
 * at 850 and `type.denseMore` at 650 — because the design data describes a
 * variable face. React Native only understands the nine hundreds, and a string
