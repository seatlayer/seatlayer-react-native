...
import { useSeatLayerPickerConfirmAddChoreography } from './confirmAddChoreography';
...
export function SeatLayerPickerAdaptiveLayout({
  ...
  const { advance: advanceAdd, landing: addLanding, stage: addStage } =
    useSeatLayerPickerConfirmAddChoreography(cardActive, scope.sessionId);
  ...
  return (
    <SeatLayerCartLandingProvider landing={addLanding}>
    <View
      ref={rootRef}
      onLayout={onLayout}
